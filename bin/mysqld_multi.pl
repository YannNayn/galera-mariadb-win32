...
$opt_help          = 0;
$opt_log           = undef();
$opt_mysqladmin    = "C:/temporary/mariadb-galera/inst_temp/Win32/bin/mysqladmin";
$opt_mysqld        = "C:/temporary/mariadb-galera/inst_temp/Win32/bin/mysqld";
$opt_no_log        = 0;
$opt_password      = undef();
$opt_tcp_ip        = 0;
$opt_user          = "root";
...
#### order:  my_print_defaults mysqld datadir, C:/temporary/mariadb-galera/inst_temp/Win32/share
####
...
sub init_log
{
  ...
  if (!defined($logdir))
  {
    $logdir= "C:/temporary/mariadb-galera/inst_temp/Win32/share" if (-d "C:/temporary/mariadb-galera/inst_temp/Win32/share" && -w "C:/temporary/mariadb-galera/inst_temp/Win32/share");
  }
  if (!defined($logdir))
  {
...
sub list_defaults_files
{
  ...
  return grep { defined $_ and not $seen{$_}++ and -f $_ and -r $_ }
              ('/etc/my.cnf',
               '/etc/mysql/my.cnf',
               'C:/temporary/mariadb-galera/inst_temp/Win32/my.cnf',
...
#
#   Before using, you must create a my.cnf file either in C:/temporary/mariadb-galera/inst_temp/Win32/my.cnf
...
[mysqld_multi]
mysqld     = C:/temporary/mariadb-galera/inst_temp/Win32/bin/mysqld_safe
mysqladmin = C:/temporary/mariadb-galera/inst_temp/Win32/bin/mysqladmin
user       = multi_admin
...
language   = C:/temporary/mariadb-galera/inst_temp/Win32/share/mysql/english
user       = unix_user1
...
language   = C:/temporary/mariadb-galera/inst_temp/Win32/share/mysql/swedish
user       = unix_user2
...
language   = C:/temporary/mariadb-galera/inst_temp/Win32/share/mysql/estonia
user       = unix_user3
...
language   = C:/temporary/mariadb-galera/inst_temp/Win32/share/mysql/japanese
user       = unix_user4
EOF
  exit(0);
}
