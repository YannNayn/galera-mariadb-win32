...
my $execdir = 'C:/temporary/mariadb-galera/inst_temp/Win32/bin';
my $bindir  = 'C:/temporary/mariadb-galera/inst_temp/Win32/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('C:/temporary/mariadb-galera/inst_temp/Win32/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('C:/temporary/mariadb-galera/inst_temp/Win32/include/mysql', "include/mysql", "include");
...
my $flags;
$flags->{libs} =
  [@ldflags,@lib_opts,'','ws2_32 z IPHLPAPI mysys_ssl w:/PBA/SE/win32/libs/ssleay32.lib w:/PBA/SE/win32/libs/libeay32.lib C:/temporary/mariadb-galera/temp_libs/Win32/libs/crypto.lib ','',''];
$flags->{libs_r} =
  [@ldflags,@lib_r_opts,'','',''];
$flags->{embedded_libs} =
  [@ldflags,@lib_e_opts,'','','','',''];
